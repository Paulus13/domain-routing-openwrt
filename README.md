...
В данном форке скрипт getdomains-install.sh слегка изменен:
 - Вместо проверки доступности репозиториев при запуске скрипта проверяется доступ в интернет
...
Вся оригинальная функциональность оставлена без изменений.
...
Запуск оригинального скрипта без скачивания
```
...
Запуск оригинального скрипта со скачиванием
```
